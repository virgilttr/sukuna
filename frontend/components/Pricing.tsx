...
const InsurancePricing: React.FC = () => {
  ...
  const claimsHistory = [
    { year: 2021, amount: 5000, description: "Water damage" },
    { year: 2022, amount: 0, description: "No claims" },
    { year: 2023, amount: 2000, description: "Minor theft" },
  ];
  ...
  const calculatePremium = (): string => {
    let category: RiskCategory =
      riskScore < 50 ? "highRisk" : riskScore < 75 ? "mediumRisk" : "lowRisk";
    let premium =
      actuarialTable[category].basePremium *
      actuarialTable[category].multiplier;
    ...
    <div className="max-w-6xl mx-auto p-8 bg-gray-900 text-gray-100">
        ...
        <CardContent>
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="text-sm text-gray-400">
              Generated by our inference models
            </span>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <Card className="bg-gray-800 border-gray-700 shadow-lg">
          ...
          <CardContent>
            <ul className="space-y-2">
              {Object.entries(competitionPricing).map(([company, price]) => (
